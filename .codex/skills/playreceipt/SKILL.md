...
4. Run `node src/cli.js audit <input.json> --out <receipt.json>` from this repository.
5. Interpret exit codes: `0` pass, `2` repair, `3` unverified, `4` human review.
6. Report the overall verdict first, then failing gates, exact evidence paths, and the smallest credible repair.
