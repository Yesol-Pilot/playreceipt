...
| 3 | Open “Audit your evidence,” show judge JSON, issue receipt | Real interaction, no account, 64 KiB cap, no app database or submission-history write path |
| 4 | Custom receipt and four-stage trail | exact copy/download handoff, 7 pass, 1 human review, no self-PASS |
| 5 | GitHub Action and test proof | one engine across UI/API/CLI/Action, CI semantics, 11/11 tests |
