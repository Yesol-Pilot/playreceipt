...
Implemented capture: `../evidence/browser/playreceipt-desktop.png`
...
|---|---|
| Persistent left case rail | Implemented with three real interactive cases and concise provenance subtitles |
...
4. Mobile uses a horizontal three-case switcher and stacked gate rows rather than compressing the desktop table.
